...
def main():
    ...
    # Partition data into training and validation sets using train_test_split
    ...
    models = [bayes_rgb_model, bayes_convert_model, knn_rgb_model,
              knn_convert_model, rf_rgb_model, rf_convert_model]
